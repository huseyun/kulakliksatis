...
import { getMe, updateMe } from "@/api/shoppers";
      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        <View style={styles.container}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text variant="bodySmall" style={styles.infoSub}>@{username} · {email}</Text>
          </View>

          <Text variant="titleSmall" style={styles.sectionTitle}>Kişisel Bilgiler</Text>
          <TextInput label="İsim" value={firstName} onChangeText={setFirstName} mode="outlined" style={styles.input} />
          <TextInput label="Soyisim" value={lastName} onChangeText={setLastName} mode="outlined" style={styles.input} />
          ...
          <Button mode="contained" onPress={handleSave} loading={saving} disabled={saving} style={styles.saveButton} contentStyle={styles.buttonContent}>
            Kaydet
          </Button>
          ...
          <Button mode="text" icon="logout" textColor="#b91c1c" onPress={logout} style={styles.logoutButton}>
            Çıkış Yap
          </Button>
        </View>
      </ScrollView>
